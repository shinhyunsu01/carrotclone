...
const LiveDetail: NextPage = () => {
	return (
		<div className="py-10 px-4 space-y-4">
			...
			<div className="pb-16  h-[50vh] overflow-y-scroll py-10 px-4 space-y-4">
			...
			<div className="fixed w-full mx-auto max-\w-md bottom-4 inset-x-0">
				<div className="flex relative items-center">
					...
					<div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0">
						<button className="flex  focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 items-center bg-orange-500 rounded-full px-3 hover:bg-orange-600 cursor-pointer  text-sm text-white">
							&rarr;
						</button>
					</div>
				</div>
